...
def main(argv):
  ...
  export_ee_data.export_ml_datasets_local(
      ...
      output_folder='D:\SoftData\graduationProject\Code\\next_day_wildfire_spread\data_export\outputData'
  )
